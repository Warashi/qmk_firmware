...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           LGUI(LSFT(KC_SPACE)),                                LALT(LCTL(LGUI(KC_H))),KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,
    MT(MOD_MEH, KC_TAB),KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           LALT(LGUI(KC_V)),                                KC_BSPACE,      KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLASH,
    LCTL_T(KC_ESCAPE),KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           LT(2,KC_SCOLON),LGUI_T(KC_QUOTE),
    LT(3,KC_NO),    KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_F24,                                         ST_MACRO_0,     KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSHIFT,
    KC_GRAVE,       KC_QUOTE,       KC_LGUI,        KC_LEFT,        KC_RIGHT,                                                                                                       KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(1),
                                                                                                    KC_LALT,        RESET,          KC_MEDIA_PLAY_PAUSE,LCTL_T(KC_ESCAPE),
                                                                                                                    KC_HOME,        KC_PGUP,
                                                                                    LSFT_T(KC_SPACE),LGUI_T(KC_LANG2),KC_END,         KC_PGDOWN,      RGUI_T(KC_LANG1),LT(1,KC_ENTER)
  ),
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_EQUAL,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_DOT,         KC_0,           KC_EQUAL,       KC_TRANSPARENT,
                                                                                    ...
                                                                                    RGB_VAD,        RGB_VAI,        KC_TRANSPARENT, KC_TRANSPARENT, RGB_HUD,        KC_TRANSPARENT
  ),
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,     KC_MS_BTN2,                                                                                                     KC_AUDIO_VOL_UP,KC_AUDIO_VOL_DOWN,KC_AUDIO_MUTE,  KC_TRANSPARENT, KC_TRANSPARENT,
                                                                           ...
                                                                           LALT(LGUI(KC_LEFT)),LALT(LGUI(KC_RIGHT)),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  ...
  switch (keycode) {
    case ST_MACRO_0:
      if (record->event.pressed) {
        SEND_STRING(SS_TAP(X_LANG2) SS_DELAY(100) SS_LALT(SS_LCTL(SS_LSFT(SS_TAP(X_SPACE)))));
    ...
    case LCTL_T(KC_ESCAPE):
      if (record->tap.count > 0) {
        if (record->event.pressed) {
          register_code16(KC_LANG2);
        } else {
          unregister_code16(KC_LANG2);
        }
      }
      break;
    case JP_LSPO:
